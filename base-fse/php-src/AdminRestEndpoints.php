	...
	private static function register_rest_routes() {
		...
		register_rest_route(
			...
			array(
				...
				'callback'            => array( '\HungryFlamingo\BaseFse\AdminRestEndpoints', 'example_route' ),
				'permission_callback' => array( '\HungryFlamingo\BaseFse\AdminRestEndpoints', 'permission_callback' ),
			)
		);
