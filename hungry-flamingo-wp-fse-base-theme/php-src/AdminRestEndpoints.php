	...
	private static function register_rest_routes() {
		...
		register_rest_route(
			...
			array(
				...
				'callback'            => array( '\HungryFlamingo\WpFseBaseTheme\AdminRestEndpoints', 'example_route' ),
				'permission_callback' => array( '\HungryFlamingo\WpFseBaseTheme\AdminRestEndpoints', 'permission_callback' ),
			)
		);
